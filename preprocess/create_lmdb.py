...
# configurations
img_folder = os.path.join('../data','dataset','trainHRreal','BSD100_sub','LR','*')  # glob matching pattern
lmdb_save_path = os.path.join('../data','dataset','trainHRreal','BSD100_sub_LR.lmdb')  # must end with .lmdb
